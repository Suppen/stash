...
use infrastructure::persistence::sqlite::db::setup_db;

pub mod application;
pub mod domain;
pub mod infrastructure;

pub fn get_services() -> Result<(ProductService, StashItemService), String> {
    ...
    let stash_item_repository: Box<dyn StashItemRepository> = Box::new(
